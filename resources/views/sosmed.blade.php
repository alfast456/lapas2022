...
<body class="">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary justify-content-sm-start fixed-top border-bottom border-dark">
        <div class="container-fluid">
            <a class=" order-1 order-lg-0 ml-lg-0 ml-5 mr-auto h4 text-white" href="#">Media Sosial</a>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mt-3">
                    <div class="card-body" style="background-color: rgb(214, 0, 214)">
                        <a href="" class="h6 text-white">
                ...
                <div class="card mt-3">
                    <div class="card-body" style="background-color: rgb(0, 86, 214)">
                        <a href="" class="h6 text-white">
                ...
                <div class="card mt-3">
                    <div class="card-body bg-dark">
                        <a href="" class="h6 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="white" class="bi bi-tiktok" viewBox="0 0 16 16">
                                <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z"/>
                              </svg>
                              @lps.narkotika.purwokerto
                        </a>
                    </div>
                </div>
            </div>
