        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <table class="table table-bordered mt-3">
                    <tbody>
                        <tr>
                            <td colspan="2">Undang-Undang Nomor 23 Tahun 2014 tentang Pelayanan Publik</td>
                            <td><a href="#"><img src="{{ asset('logo/unduh-depositphotos-bgremover.png')}}" alt="" height="35" class="d-inline-block align-text-top float-right"></a></td>
                        </tr>
                        <tr>
                            <td colspan="2">Undang-Undang Nomor 23 Tahun 2014 tentang Pelayanan Publik</td>
                            <td><a href="#"><img src="{{ asset('logo/unduh-depositphotos-bgremover.png')}}" alt="" height="35" class="d-inline-block align-text-top float-right"></a></td>
