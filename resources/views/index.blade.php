                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            <div class="brand-logo">
                                <img src="{{ asset('main/img/kemenkumham1.png')}}" class="rounded" height="150" weight="60" alt="logo">
                                <img src="{{ asset('main/img/SILANATO1.png')}}" class="rounded" height="150" weight="60" alt="logo">
                            </div>
                            <div class="text-center">
                                <h5 class="text-center">SISTEM INFORMASI DAN LAYANAN <br>LAPAS NARKOTIKA IIB PURWOKERTO </h5>
                            </div>
                            <form method="POST" action="{{ route('login') }}" class="pt-3">
                                ...
                                <div class="mt-3">
                                    ...
                                    <a href="{{ route('password.request') }}" style="margin-left: 11rem; color: red;">Lupa kata sandi?</a>
                                    @endif
