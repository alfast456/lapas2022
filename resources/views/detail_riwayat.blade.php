...
<body class="">
    ...
    <div class="container" style="margin-top: 4rem">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <a href="/informasi1" class="btn btn-primary">Kembali</a>
                <div class="card mt-3">
                    <div class="card-body d-flex justify-content-center">
                        <img src="{{ asset('logo/foto selfie.jpg')}}" alt="" height="150" class="d-inline-block align-text-top rounded">
                    </div>
                    <div class="card-body">
                        ...
                        <h6>Nama Warga Binaan</h6>
                        <h6>Hubungan dengan WBP</h6>
                    </div>
                </div>
            </div>
        </div>
