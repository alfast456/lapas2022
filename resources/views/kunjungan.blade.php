                        ...
                        <div class="row">
                            <div class="col mt-3">
                                ...
                                <div class="form-group bg-white rounded">
                                    <a class="form-control" href="{{ route('form-kunjungan') }}">
                                        Kunjungan Tatap Muka
                                        <img src="{{ asset('logo/panah-removebg-preview.png')}}" alt="" height="24"
                                            class="d-inline-block align-text-top float-right">
                                    </a>
                                </div>
                                <div class="form-group bg-white rounded">
                                    <a class="form-control" href="{{ route('riwayat') }}">
                                        Riwayat Kunjungan
                                        <img src="{{ asset('logo/panah-removebg-preview.png')}}" alt="" height="24"
                                            class="d-inline-block align-text-top float-right">
                                    </a>
